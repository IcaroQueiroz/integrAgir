...
"""pyinstaller --onefile --noconsole --add-data "custom;custom" --add-data "icons;icons" --add-data 
"img;img" --add-data "interface.py;." --add-data "Resources_rc.py;." --add-data "Resources.qrc;." maim.py
"""